...
<body class="admin-bg text-gray-100">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <button id="notificationBtn" class="bg-gray-800 p-2 rounded-full hover:bg-gray-700">
                                ...
                                <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center notification-badge">3</span>
                            </button>
                            <!-- Dropdown Notifikasi -->
                            <div id="notificationDropdown" class="absolute right-0 mt-2 w-80 bg-gray-800 rounded-lg shadow-xl z-50 hidden dropdown-enter">
                                    ...
                                    <div class="p-3 border-b border-gray-700 hover:bg-gray-700">
                                        <div class="flex items-start">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-gray-400 text-sm">Andi Setiawan bergabung sebagai petugas pendaftaran</p>
                                    ...
                                    <div class="p-3 hover:bg-gray-700">
                                        <div class="flex items-start">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-gray-400 text-sm">Laporan April 2025 telah siap diunduh</p>
                                ...
                                <div class="p-3 border-t border-gray-700">
                                    <a href="#" class="text-blue-400 text-sm hover:text-blue-300">Lihat semua notifikasi</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- User Menu -->
                        <div class="relative">
                            <button id="userMenuBtn" class="flex items-center space-x-2 bg-gray-800 hover:bg-gray-700 p-2 rounded-lg">
                            ...
                            <!-- Dropdown Menu -->
                            <div id="userDropdown" class="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl z-50 hidden dropdown-enter">
                                <div class="p-4 border-b border-gray-700">
                                ...
                                <div class="border-t border-gray-700">
                                    <button id="btnLogout" class="w-full text-left p-3 text-red-400 hover:bg-red-900/20 flex items-center">
                    ...
                    <div class="glass-card rounded-xl p-6">
                        ...
                        <div class="space-y-4 max-h-64 overflow-y-auto pr-2">
                            <div class="flex items-start p-3 bg-gray-800/30 rounded-lg">
                                ...
                                <div class="flex-1">
                                    <p class="font-medium">Petugas baru ditambahkan</p>
                                    <p class="text-gray-400 text-sm">Syahril Bahoa ditambahkan sebagai petugas Loket 1</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="glass-card rounded-xl p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center p-3 bg-gray-800/30 rounded-lg">
                                ...
                                <span class="bg-yellow-500/20 text-yellow-400 px-3 py-1 rounded-full text-sm">Berjalan</span>
                            </div>
                    ...
                    <div class="glass-card rounded-xl p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <button class="bg-blue-900/30 hover:bg-blue-800/40 p-4 rounded-lg flex flex-col items-center justify-center transition">
                                <i class="fas fa-file-export text-blue-400 text-2xl mb-2"></i>
                                <span class="text-sm font-medium">Export Data</span>
                            </button>
                            
                            <button class="bg-green-900/30 hover:bg-green-800/40 p-4 rounded-lg flex flex-col items-center justify-center transition">
                                <i class="fas fa-print text-green-400 text-2xl mb-2"></i>
                                <span class="text-sm font-medium">Cetak Laporan</span>
                            </button>
                            
                            <button class="bg-purple-900/30 hover:bg-purple-800/40 p-4 rounded-lg flex flex-col items-center justify-center transition">
                                <i class="fas fa-cog text-purple-400 text-2xl mb-2"></i>
                                <span class="text-sm font-medium">Pengaturan</span>
                            </button>
                            
                            <button class="bg-red-900/30 hover:bg-red-800/40 p-4 rounded-lg flex flex-col items-center justify-center transition">
                    ...
                    <div class="glass-card rounded-xl p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <button class="w-full bg-gray-800 hover:bg-gray-700 py-3 rounded-lg flex items-center justify-center">
            ...
            <form id="addOfficerForm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="text" class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500" placeholder="Masukkan nama petugas" required>
                    </div>
                    
                    <div>
                        <label class="block text-gray-300 mb-2">Email</label>
                        <input type="email" class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500" placeholder="email@klinikanugrah.com" required>
                    </div>
                    
                    <div>
                        <label class="block text-gray-300 mb-2">Nomor Telepon</label>
                        <input type="tel" class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500" placeholder="0812-3456-7890" required>
                    </div>
                    
                    <div>
                        <label class="block text-gray-300 mb-2">Loket</label>
                        <select class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500" required>
                ...
                <div class="mb-6">
                    ...
                    <textarea class="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-3 focus:outline-none focus:border-blue-500" rows="3" placeholder="Tambahkan catatan jika perlu..."></textarea>
                </div>
                
                <div class="flex justify-end space-x-4">
                    <button type="button" id="cancelAddOfficer" class="bg-gray-700 hover:bg-gray-600 px-6 py-3 rounded-lg">
                        Batal
                    </button>
    ...
    <script>
        // Data petugas
        let officersData = [
            { id: 1, name: 'Syahril Bahoa', counter: 'Pendaftaran 1', status: 'aktif', queueToday: 24 },
            { id: 2, name: 'Rehan Blongkod', counter: 'Pendaftaran 2', status: 'aktif', queueToday: 18 },
            { id: 3, name: 'Hendrik Hatibae', counter: 'Farmasi', status: 'aktif', queueToday: 32 },
        ...
        function setupEventListeners() {
            ...
            // Quick actions
            document.querySelectorAll('.bg-blue-900\\/30, .bg-green-900\\/30, .bg-purple-900\\/30, .bg-red-900\\/30').forEach(btn => {
                btn.addEventListener('click', function() {
        ...
        function resetAdminUI() {
            ...
            officersData = [
                { id: 1, name: 'Syahril Bahoa', counter: 'Pendaftaran 1', status: 'aktif', queueToday: 24 },
                { id: 2, name: 'Andi Setiawan', counter: 'Pendaftaran 2', status: 'aktif', queueToday: 18 },
                { id: 3, name: 'Budi Santoso', counter: 'Farmasi', status: 'aktif', queueToday: 32 }
            ];
