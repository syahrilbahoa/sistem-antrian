...
<body class="login-bg">
                ...
                <div class="login-container rounded-3xl p-8 lg:p-10">
                    ...
                    <form method="POST" action="/login">
                        ...
                        <div class="input-group">
                            <input type="email" name="email" required class="w-full p-4 text-white rounded-xl">
                            <label>Email</label>
                        </div>

                        <div class="input-group">
                            <input type="password" name="password" required class="w-full p-4 text-white rounded-xl">
    ...
    function simulateLogin(username, password, remember) {
        ...
        setTimeout(() => {
            ...
            if (user) {
                ...
                setTimeout(() => {
                    document.getElementById('loginForm').classList.remove('animate__animated',
                        'animate__shakeX');
                }, 1000);
            }
        }, 1500);
    ...
    function showAlert(type, message) {
        ...
        if (type === 'success') {
            ...
            alertDiv.className = alertDiv.className.replace('bg-green-500', 'bg-red-500').replace('bg-yellow-500',
                'bg-red-500');
            alertDiv.querySelector('.fa-check-circle, .fa-exclamation-triangle').className =
                'fas fa-exclamation-circle text-xl mr-3';
